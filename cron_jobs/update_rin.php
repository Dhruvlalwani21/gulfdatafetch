...
/** /usr/bin/php /home/u110616855/domains/first1.us/public_html/cron_jobs/update_rin.php **/
/** /bin/sh /home/u110616855/domains/first1.us/public_html/cron_jobs/update_rin.sh **/
/** http://local.officere.com/cron_jobs/update_rin.php **/
...
/* Query Server */
if($login){     
    $sqllastTime = "SELECT last_time FROM last_modified WHERE last_time!='' AND PropertyClass='$PropertyClass' LIMIT 1";    $resultTime=mysqli_query($conn,$sqllastTime) or die(mysqli_error($conn));
