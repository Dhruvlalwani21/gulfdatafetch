...
/** /usr/bin/php /home/u110616855/domains/first1.us/public_html/cron_jobs/update_com.php **/
/** /bin/sh /home/u110616855/domains/first1.us/public_html/cron_jobs/update_com.sh **/
/** http://local.officere.com/cron_jobs/update_com.php **/
...
/* Query Server */
if($login){     
    $sqllastTime = "SELECT last_time FROM last_modified WHERE last_time!='' AND PropertyClass='COM' LIMIT 1"; 
    ...
    $rets->Disconnect();  
      ...
      $upMod="UPDATE last_modified SET last_time='$start_time' WHERE last_time!='' AND PropertyClass='COM'";
      $modRslt=mysqli_query($conn,$upMod) or die(mysqli_error($conn));
      
      $sqlAllListings = "SELECT matrix_unique_id FROM properties WHERE matrix_unique_id!='' AND PropertyClass='COM'"; 
