...
$fp = fopen($path."load_pictures_lock_1.txt", "w+");
/** /usr/bin/php /home/u110616855/domains/first1.us/public_html/cron_jobs/load_pictures_1.php **/
/** /bin/sh /home/u110616855/domains/first1.us/public_html/cron_jobs/load_pictures_1.sh **/
/** http://local.officere.com/cron_jobs/load_pictures_1.php **/
...
if($login){
    ...
    $sqlUniqueID = "SELECT property_id, matrix_unique_id, MLSNumber, PropertyAddress FROM properties WHERE AllPixDownloaded='No' ORDER BY Status ASC, last_image_query ASC LIMIT 25"; //AND MLSNumber='221025670'
