...
/** /usr/bin/php /home/u110616855/domains/first1.us/public_html/cron_jobs/fetch_dock.php **/
/** /bin/sh /home/u110616855/domains/first1.us/public_html/cron_jobs/fetch_dock.sh **/
/** http://local.officere.com/cron_jobs/fetch_dock.php **/
...
if($login){
    ...
    $status_ftch = 'A';
    $results = $rets->Search('Property', $PropertyClass, '(Status=|'.$status_ftch.'),(MatrixModifiedDT=1900-01-01T00:00:00+)',['Limit' => 250,'Offset' => $offset,'QueryType' => 'DMQL2','Format' => 'COMPACT-DECODED',]); // 'Format' => 'COMPACT-DECODED', '(LIST_15=|12LL26N0CFUH)
