...
$sec_path = "/kunden/homepages/27/d962833332/htdocs/gulfshore/";   
}
    
//$fp = fopen("/kunden/homepages/27/d962833332/htdocs/first1.us/cron_jobs/load_pictures_lock_1.txt", "w+");
/** /usr/bin/php /home/u110616855/domains/first1.us/public_html/cron_jobs/load_picture.php **/
/** /bin/sh /home/u110616855/domains/first1.us/public_html/cron_jobs/load_picture.sh **/
/** http://local.officere.com/cron_jobs/load_picture.php **/
...
if($login){
    ...
    $sqlUniqueID = "SELECT property_id, matrix_unique_id, MLSNumber, PropertyAddress FROM properties WHERE AllPixDownloaded='No' ORDER BY Status ASC LIMIT 1"; //AND MLSNumber='221005737'
    ...
    **/ 
    ...
    foreach($photos as $photo){ 
     ...
     if(!$isError){
        file_put_contents($sec_path."$ThisImgPic", $image); 
     }else{
        print_r($getError);
     } 
     }
    ...
    echo "$counter Pictures Downloaded for $MLSNumber";
